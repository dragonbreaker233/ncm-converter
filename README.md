...
Windows 10 / 11 用户，打开开始菜单搜 `cmd`，复制下面这行进去回车：

```bash
winget install Python.Python.3.12
```

或者手动下载：[python.org](https://www.python.org/downloads/)，**安装时记得勾选「Add Python to PATH」**。
...
# 图形界面
python ncm_converter_gui.pyw

# 或命令行
python ncm_converter.py song.ncm
python ncm_converter.py D:\Music\NCM\ -r --cover
```
